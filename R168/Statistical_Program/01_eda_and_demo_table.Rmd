...
##only missingness is from the "AED Received while on Keppra" variable
...
dim(keppra_demo_survived) #805  24

#log vars
tableOne_log <- CreateTableOne(vars = c(
                        "log_Length_of_Stay_Hospital",
                        "log_Length_of_Stay_ICU",
                        "log_Total_Keppra_Doses",
                        "log_Keppra_Duration"
...
#no log vars
tableOne_nolog <- CreateTableOne(vars = c(
                        "Length_of_Stay_Hospital",
                        "Length_of_Stay_ICU",
                        "Total_Keppra_Doses",
                        "Keppra_Duration"
